...
def update(drone):
    ...
    center = uav_utils.get_contour_center(largest_bright_contour)
    area = uav_utils.get_contour_area(largest_bright_contour)
    
    
    if _timer >= HOVER_TIME:
        print(f"The largest gate's center is at row {center[0]} and column {center[1]} . The gate's area is {area}.")
        _done = True
