...
BASHEOF
    ...
    echo ""
    echo "  New-NetFirewallRule -DisplayName \"WSL2 UAVNeo Simulator\" -Direction Inbound -InterfaceAlias \"vEthernet (WSL)\" -Action Allow -Protocol UDP -LocalPort 5064-5065"
    echo ""
